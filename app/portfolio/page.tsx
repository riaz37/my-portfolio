        ...
        <div className="min-h-screen">
          ...
          >
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-32">
              ...
              >
                Explore my projects, skills, and achievements. From web
                applications to design systems, discover how I bring ideas to
              ...
              >
                <div className="flex items-center gap-2 text-sm sm:text-base text-muted-foreground backdrop-blur-sm px-4 py-2 rounded-full bg-primary/5 border border-primary/10">
                  <span className="inline-block w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
                  Available for Work
                </div>
                <div className="flex items-center gap-2 text-sm sm:text-base text-muted-foreground backdrop-blur-sm px-4 py-2 rounded-full bg-secondary/5 border border-secondary/10">
